module.exports.config = {
  ...
  hasPermssion: 2,
  credits: "SAHU",
  description: "random sexy girl images",
  commandCategory: "IMG",
  usages: "sexy",
  cooldowns: 2,
  dependencies: {
...
module.exports.run = async ({ api, event, args, Users, Threads, Currencies }) => {
  ...
  const callback = () => api.sendMessage({
    body: "ভন্ড হাত মারবি না কিন্তু 🥵",
    attachment: fs.createReadStream(__dirname + "/cache/sexypp.jpg")
  }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/sexypp.jpg"));  

  return request(encodeURI(randomLink))
    .pipe(fs.createWriteStream(__dirname + "/cache/sexypp.jpg"))
    .on("close", () => callback());
};
